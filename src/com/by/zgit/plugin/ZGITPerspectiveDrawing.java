package com.by.zgit.plugin;

import org.eclipse.ui.IFolderLayout;
import org.eclipse.ui.IPageLayout;
import org.eclipse.ui.IPerspectiveFactory;

import com.by.zgit.plugin.view.ZGITViewTwo;
 ...
 *
 */
public class ZGITPerspectiveDrawing implements IPerspectiveFactory {
    ...
    public void createInitialLayout(IPageLayout layout) {
        ...
        bottom.addView(ZGITViewTwo.class.getName());// 由于我们把视图的id取成和类全名一样，所以也可以用这种写法
